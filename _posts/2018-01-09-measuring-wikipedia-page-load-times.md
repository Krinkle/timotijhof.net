...
| ![Line graph for responseStart metric from desktop pageviews. Values range from 250ms to 450ms. Averaging around 330ms.](/assets/attachments/2018_measuring_figure_2a_desktop.png){:class="md-box"} | ![Line graph for responseStart metric from mobile pageviews. Values range from 350ms to 700ms. Averaging around 520ms.](/assets/attachments/2018_measuring_figure_2b_mobile.png){:class="md-box"}
{:class="md-block"}
